...
let maxAllowedIfReset = (lpReservesX - oracleRateWithFee * lpReservesY) / oracleRateWithFee
...
let validSuccessor = successor.tokens() == SELF.tokens()                     &&
...
const contract = sigmaProp(validDelay && validThreshold && validAmount && validBankBoxInOut && validLpBox && validBuyBackIn &&
